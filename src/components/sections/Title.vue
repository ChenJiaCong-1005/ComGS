...
// 标题
const title = 'Motion Matters: Compact Gaussian Streaming for Free-Viewpoint Video Reconstruction'
...
<template>
  <div>
    ...
    <el-row justify="center">
      <el-col :span="24">
        <el-alert title="🔥 [2025-09-19] This paper is accepted by NeurIPS 2025." />
      </el-col>
    </el-row>
